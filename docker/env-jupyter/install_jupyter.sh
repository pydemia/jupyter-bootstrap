...
bash -ic "pip install ipython jupyter \
&& conda install \
nb_conda \
...
&& pip install jupyter-tensorboard nbgrader"

bash -ic "conda install -c conda-forge jupyter_contrib_nbextensions -y \
...
bash -ic "mkdir -p /home/pydemia/.local/share/jupyter/nbextensions/jupyter_themes"
bash -ic "wget https://raw.githubusercontent.com/merqurio/jupyter_themes/master/theme_selector.js -O /home/pydemia/.local/share/jupyter/nbextensions/jupyter_themes/theme_selector.js"
